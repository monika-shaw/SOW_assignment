const GlobalConstants = {
    CommunityImages: [
        {
            image: "/src/assets/communityImages/arabian-ranches-ii.jpg",
        ...
        {
            image: "/src/assets/communityImages/arabian-ranches.jpg",
            title: "Arabian Ranches II ",
            description: "Arabian Ranches offers a modern interpretation of the soothing charm of the surrounding desertscape. The development features a number of residential communities that draw inspiration from Spanish and Arabian architecture.",
        },
        {
            image: "/src/assets/communityImages/downtown-dubai.jpg",
        ...
        {
            image: "/src/assets/communityImages/dubai-hills-estate.jpg",
        ...
        {
            image: "/src/assets/communityImages/dubai-marina.png",
            title: "Dubai Marina",
        ...
        {
            image: "/src/assets/communityImages/emirates-living.jpg",
